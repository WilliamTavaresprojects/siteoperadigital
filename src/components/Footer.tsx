...
export const Footer: React.FC<FooterProps> = ({ 
  ...
  const [waLink, setWaLink] = useState(() => getWhatsAppLink("Olá! Preciso de suporte."));

  useEffect(() => {
    const update = () => setWaLink(getWhatsAppLink("Olá! Preciso de suporte."));
  ...
  return (
    <footer className="bg-[#030712] text-slate-400 pt-16 pb-12 border-t border-slate-800 text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-slate-400 text-xs leading-relaxed max-w-sm">
              Desenvolvimento de websites institucionais, e-commerces de alta conversão, aplicativos web e automações para WhatsApp Web.
            </p>

            {/* Parceiro Oficial Banner */}
            <div className="inline-flex items-center gap-2.5 p-2.5 px-3.5 bg-slate-900 border border-slate-800 rounded-xl">
              <ShieldCheck className="w-5 h-5 text-emerald-400" />
              <div>
                <span className="text-[10px] font-bold text-slate-400 block uppercase tracking-wider">Certificação</span>
                <span className="text-xs font-extrabold text-emerald-400">Parceiro Oficial Ecossistema</span>
              </div>
            </div>
          ...
          {/* Column 2: Produtos & Serviços */}
          <div className="space-y-3">
            <h4 className="font-bold text-sm text-white uppercase tracking-wider">
              Serviços
            </h4>
            <ul className="space-y-2 text-slate-400">
              <li><a href="#produto-websites" className="hover:text-white transition-colors">Desenvolvimento Web & E-commerce</a></li>
              <li><a href="#produto-mobile-apps" className="hover:text-white transition-colors">Aplicativos Web Personalizados</a></li>
              <li><a href="#produto-whatsapp-services" className="hover:text-white transition-colors">Serviço & Automação WhatsApp Web</a></li>
              <li><a href="#produto-custom-systems" className="hover:text-white transition-colors">Sistemas Web Sob Medida</a></li>
              <li><a href="#agentes-ia" className="hover:text-white transition-colors font-medium text-blue-400">Robôs & Agentes WhatsApp</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><a href={waLink} target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Suporte via WhatsApp</a></li>
