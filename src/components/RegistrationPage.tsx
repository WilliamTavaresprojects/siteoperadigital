  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white flex flex-col font-sans">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 min-h-[calc(100vh-57px)]">
        ...
        <div className="lg:col-span-7 bg-[#030712] p-6 sm:p-12 flex items-center justify-center border-l border-slate-800">
          <div className="w-full max-w-lg space-y-6">
            ...
            {!isSubmitted ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full text-base sm:text-sm pl-10 pr-3 h-12 rounded-xl bg-[#0B0F19] border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-base sm:text-sm px-3.5 h-12 rounded-xl bg-[#0B0F19] border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full text-base sm:text-sm pl-10 pr-12 h-12 rounded-xl bg-[#0B0F19] border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-1 top-1.5 h-9 w-10 flex items-center justify-center text-slate-500 hover:text-slate-300 focus:outline-none"
                      >
                  ...
                  <div className="space-y-2 pt-2 text-xs text-slate-400">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="rounded border-slate-700 bg-slate-900 text-[#0A4EE4] focus:ring-[#0A4EE4]"
                      />
                    ...
                    <label className="flex items-start gap-2 cursor-pointer pt-1">
                      <input
                        ...
                        className="rounded border-slate-700 bg-slate-900 text-[#0A4EE4] focus:ring-[#0A4EE4] mt-0.5"
                      />
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#0A4EE4] hover:bg-blue-600 text-white font-extrabold text-base py-3.5 rounded-xl shadow-lg shadow-blue-600/25 transition-all duration-200 mt-4 flex items-center justify-center gap-2"
                  >
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-[#030712] px-3 text-slate-500 font-semibold">
                      Ou cadastre-se com
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-2.5 px-4 bg-[#0B0F19] hover:bg-slate-900 border border-slate-800 rounded-xl text-xs font-semibold text-slate-300 transition-colors"
                  >
              ...
              <div className="bg-[#0B0F19] rounded-2xl p-8 border border-slate-800 shadow-xl text-center space-y-6 animate-in fade-in duration-300">
                <div className="w-16 h-16 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-2xl flex items-center justify-center mx-auto shadow-sm">
                ...
                <div className="p-4 bg-slate-900 rounded-xl border border-slate-800 text-left text-xs space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-slate-200">{formData.email || 'usuario@exemplo.com'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">CNPJ:</span>
                    <span className="font-semibold text-slate-200">{formData.cnpj || 'Não informado'}</span>
                  </div>
                </div>

                <button
                  onClick={onNavigateHome}
                  className="w-full bg-[#0A4EE4] hover:bg-blue-600 text-white font-bold py-3.5 rounded-xl shadow-md transition-colors text-sm"
                >
